...
// Tu código acá:
const title=  document.querySelector ( '#createdBy' ) ;
title.innerHTML= title.innerHTML + 'Celeste';
...
function buildToDo(todo, index) {
 ...
 //4) Utilizando el objeto toDo pasado como argumento, setear el 'toDoText' innerHTML
//       asignándole el valor de la propiedad 'description' del=al objeto ToDo.
...
//buildToDos(toDoItems).forEach(toDoContainer.appendChild);
};
}
